...
void setup() {
    ...
    Serial.println("Select a section to run:");
    Serial.println("1: Section 1 and 2");
    Serial.println("2: Section 3");
    Serial.println("3: Section 4");
...
void loop() {
    ...
    if (Serial.available() > 0) {
        ...
        if (input >= '1' && input <= '3') {
            selectedSection = input - '0'; // Convert char to integer
            Serial.print("Section ");
            Serial.print(selectedSection);
    ...
    // Call the function based on the selected section
...
void section3() {
    ...
    for (int angle = 30; angle <= 150; angle += resolution) {
        ...
        delay(150);
        // Delay to slow down the sensor noticeably with more pings
