...
const int UpsideDown = 180;        // Set to 180 degrees if servo is upside down, 0 otherwise
...
void setup() {
  ...
  myservo.write(90);              // Test and position Servo to 90 degrees on startup.
  delay(500);                     // Delay in milliseconds to allow finish of movement
  myservo.write(UpsideDown-30);   // Test and position Servo to 30 degrees on startup.
  delay(500);                     
  myservo.write(UpsideDown-150);  // Test and position Servo to 150 degrees on startup.
  delay(500);                     
  myservo.write(90);
  delay(500); }
                                  //
    ...
    /***************************************/
                                           //
void loop() {
  int select = 1;               // Set select = 1 for "straight ahead", "2" for scanning side to side
  switch (select) {
        case 1:
          straight_ahead();
          break;
